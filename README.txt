...
Они собраны в Test Suite и могут быть запущены все сразу через запуск "testng.xml" файла, или через вызов "mvn test" из папки проекта,
так как "testng.xml" указан в <suiteXmlFiles> в "pom.xml" проекта.
